...
<body>
    ...
    <div class="col anh4k">
        <img style="width: 700px; height:450px; margin-left: 50px; float: left; margin-right: 40px;" src="/NYH/public/image/anhlaptop/anh4k5.jpg" alt="">

        <div class="col">
            <img style=" width:500px; height: 220px;" src="/NYH/public/image/anhlaptop/anh4k3.jpg" alt="">
        </div>
        <div class="col">
            <img style=" width: 500px; height: 220px; margin-top: 10px;" src="/NYH/public/image/anhlaptop/anh7.jpg" alt="">
        </div>
    </div>
