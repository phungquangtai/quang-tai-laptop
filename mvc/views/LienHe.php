...
<!--DIA CHI -->
    <div id="dc1"> 
      <ul>
      	  <li><i class="fas fa-map-marker-alt" style="color:#8A2908; margin-right: 20px;"></i><a href="#" title="diachi">Viet Nam</a></li>
      </ul>
    </div>
...
<!--SO DIEN THOAI -->
    <div id="sdt1"> 
      <ul style="float:left;">
      	  <li> <i class="fas fa-phone-alt" style="margin-right:20px;"></i><a href="#" title="">0346019694</a></li>
          
      </ul>
      <ul>
      <li><i class="fas fa-envelope" style="margin-right:20px;"></i><a href="#" title="Email:acc@gmail.com">Email:phungtai112@gmail.com</a></li>
      </ul>
    </div> 
