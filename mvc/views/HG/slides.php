            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner slide">
                    <div class="carousel-item active aa">
                        ...
                        <img src="../public/image/hinhbia/11.jpg" class="d-block w-100 " alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h5 style="font-size: 35px;"></h5>
                            <p>Luôn mang đến những sản phẩm chất lượng</p>
                        </div>
                    </div>
                    <div class="carousel-item aa">
                        <img src="../public/image/hinhbia/22.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                        </div>
                    </div>
                    <div class="carousel-item aa">
                        <img src="../public/image/hinhbia/34.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                        </div>
                    </div>
                </div>
