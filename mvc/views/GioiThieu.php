...
<body>
    ...
    <div class="gt">
        ...
        <h2>THÔNG TIN GIỚI THIỆU VỀ CỬA HÀNG LAPTOP PQT</h2>
    </div>
    <div class="content">
        <div class="row">
            <div class="col-5">
                <img src="/NYH/public/image/anhlaptop/gioithieu.jpeg" alt="">
                <div class="haianh">
                    <img src="/NYH/public/image/hinhbia/banner1.jpg" alt="">
                    <img src="/NYH/public/image/anhlaptop/anh8.jpg" alt="">
                </div>
            </div>
            ...
            <p>Mặt hàng kinh doanh: máy tính bao gồm các thương hiệu như DELL, ASUS, LENOVO, MACBOOK , HP,...
                ...
                <br>LAPTOP PQT là một cửa hàng quy mô nhỏ chuyên bán các loại máy tính, nhưng lại cung cấp đầy đủ, đa dạng các loại sản phẩm. Ưu thế lơn nhất của cửa hàng là phục vụ khách hàng 24/24, đây được xem là điểm cộng có thể đáp ứng được nhu cầu khách hàng.</br>
                <br>LAPTOP PQT cam kết bán hàng chính hãng, sản phẩm vô cùng phong phú, đa dang
            </p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card d-flex mx-auto">
                ...
                <div class="dm"> <span id="name">LAPTOP PQT<br></span> </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card d-flex mx-auto">
        ...
        <div class="col-md-4">
            <div class="card d-flex mx-auto ">
                ...
                <div class="card-text">
                    <div class="card-title">LAPTOP PQT</div> 
